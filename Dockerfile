...
FROM alpine:3.23@sha256:25109184c71bdad752c8312a8623239686a9a2071e8825f20acb8f2198c3f659 AS pcf
...
LABEL org.opencontainers.image.source="${VCS_URL}" \
    ...
    org.opencontainers.image.title="pcf" \
    org.opencontainers.image.description="Aether 5G Core PCF Network Function" \
